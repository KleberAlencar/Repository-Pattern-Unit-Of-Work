...
using RepositoryStore.Domain.SharedContext.Common;
using RepositoryStore.Domain.SharedContext.Exceptions;
using RepositoryStore.Domain.SharedContext.Exceptions.Email;
